...
> [!INFO]
> 
> Your final delivery should look like:
> - https://github.com/reveurmichael/session2-practice-ci-cd
> 
> Make sure you check the Button "Actions" and "Releases" to see the workflow and releases.
>
> When finisehd, send the URL to the WeChat group.
      ...
      - name: Create GitHub Release
        ...
        run: |
          gh release create "v${{ github.run_number }}" \
            ...
            --notes "Automated release generated by CI/CD pipeline." \
            "./linear_model.txt"
```
...
**PLEASE GIT ADD COMMIT PUSH YOUR CODE ON THE MAIN BRANCH. Then:**
