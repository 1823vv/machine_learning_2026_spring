...
1. Write a regularized objective using an empirical loss $\mathcal{L}_{train}(W)$ plus an L1 penalty.
2. Write a regularized objective using $\mathcal{L}_{train}(W)$ plus an L2 penalty. Explain the role of $\lambda$.
