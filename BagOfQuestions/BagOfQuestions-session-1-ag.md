## Question: Polynomial Regression as Feature Engineering

A dataset shows a curved relationship between $x$ and $y$, so a straight line underfits.

1. Write a degree-2 polynomial regression model.
2. Write a degree-3 polynomial regression model.
